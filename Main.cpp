...
int WinMain()
{
	...
	Texture textures[]
	{
		Texture("assets/defaults/textures/planks.png", "diffuse", 0, GL_RGBA, GL_UNSIGNED_BYTE),
		Texture("assets/defaults/textures/planksSpec.png", "specular", 1, GL_RED, GL_UNSIGNED_BYTE)
	};
