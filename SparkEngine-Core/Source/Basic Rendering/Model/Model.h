...
public:
	...
	void Draw(Shader& shader, Camera& camera, glm::vec3 translation, glm::quat rotation, glm::vec3 scale, std::vector<light_Infos> lights);
	void DrawPathTraced(Shader& shader,Camera& camera,glm::vec3 translation,glm::quat rotation,glm::vec3 scale, std::vector<light_Infos> lights, PathTracingInfos infos);
