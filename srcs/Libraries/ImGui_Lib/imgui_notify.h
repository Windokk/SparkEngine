...
namespace ImGui
{
	...
	/// </summary>
	NOTIFY_INLINE void MergeIconsWithLatestFont()
	{
		...
		GetIO().Fonts->AddFontFromFileTTF("assets/defaults/gui/engine/fonts/fa-solid-900.ttf", 13.0f, &icons_config, icons_ranges);
	}
}
